<%-- 
    ...
    Created on : Feb 25, 2024, 2:54:41 PM
    Author     : Admin
--%>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-5 col-12">
                <div class="header-search">
                    ...
                    <form action="home" method="GET">
                        ...
                        <input type="text" placeholder="Nhập để tìm kiếm sản phẩm..." name="keyword"/>
            ...
            <div class="col-lg-6 col-md-4 col-12">
                <div class="logo-area text-center logo-xs-mrg">
                    <a href="${pageContext.request.contextPath}/home" style="font-family: Arial, sans-serif; font-size: 46px; color: #51585e; text-decoration: none;">
                        HonagBook
                    </a>
                </div>
            </div>
