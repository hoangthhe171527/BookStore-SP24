    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete-modal-label">Xác nhận xoá tài khoản</h5>
            ...
            <div class="modal-footer">
                <form action="account?action=delete" method="POST">
                    <div class="form-group" style="display: none">
                        <input type="text" class="form-control" id="idDeleteAccountInput" name="id" value="">
                    </div>
...
<script>
    function deleteAccountModal(id) {
        let inputId = document.querySelector("#idDeleteAccountInput");
        inputId.value = id;
    }
</script>